...
describe('Transform Federation stress', function () {
    it('should resolve references', function () { return __awaiter(void 0, void 0, void 0, function () {
        var executableSchema, federationSchema, result;
            ...
            switch (_a.label) {
                case 0:
                    executableSchema = graphql_tools_1.makeExecutableSchema({
                        ...
                        resolvers: {
                            Query: {
                                productById: function (source, _a) {
                                    var id = _a.id;
                    ...
                    federationSchema = transform_federation_1.transformSchemaFederation(executableSchema, {
                        Product: {
                            keyFields: ['id'],
                            extend: true,
                            resolveReference: function (reference, context, info) { return __awaiter(void 0, void 0, void 0, function () {
                                var res;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, graphql_tools_1.delegateToSchema({
                                                schema: info.schema,
                                                operation: 'query',
